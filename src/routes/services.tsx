      ...
      <section className="py-20 md:py-28">
        <div className="container-x">
          <div className="mx-auto max-w-3xl text-center">
            <div className="mb-3 text-xs font-semibold uppercase tracking-[0.3em] text-gold">What Urbanx Connects</div>
            <h2 className="text-3xl font-bold text-primary md:text-5xl">A service ecosystem for modern urban living</h2>
            <p className="mt-5 text-muted-foreground">
              The website content brief positions Urbanx as a one-stop solution for everyday living. These are the core service areas that sit underneath the brand.
            </p>
          </div>

          <div className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {urbanxServiceAreas.map((service) => (
              <div key={service.title} className="group rounded-2xl border border-border bg-card p-7 shadow-card-luxe hover-lift">
      ...
      <section className="bg-secondary/40 py-20">
        <div className="container-x">
          <div className="mx-auto mb-14 max-w-3xl text-center">
            <div className="mb-3 text-xs font-semibold uppercase tracking-[0.3em] text-gold">At a Glance</div>
            <h2 className="text-3xl font-bold text-primary md:text-5xl">Numbers that show the scale of the brief</h2>
          </div>
      ...
      <section className="py-20 md:py-28">
        <div className="container-x">
          <div className="mb-12 flex flex-wrap items-end justify-between gap-4">
            <div>
              <div className="mb-3 text-xs font-semibold uppercase tracking-[0.3em] text-gold">Brands</div>
              <h2 className="gold-underline text-3xl font-bold text-primary md:text-5xl">Dedicated pages for the active brands</h2>
            </div>
            <Link to="/contact" className="inline-flex items-center gap-2 text-sm font-semibold text-primary hover:text-gold">
        ...
        <div className="container-x">
          <div className="rounded-3xl bg-gradient-to-br from-primary via-navy to-primary p-10 text-center text-white shadow-luxe md:p-16">
            <div className="mx-auto max-w-3xl">
              ...
              <h2 className="mb-4 text-3xl font-bold md:text-5xl">Need a service plan that fits your situation?</h2>
              <p className="mb-8 text-white/80">
                Urbanx is structured to handle both everyday needs and larger operational requirements with one point of contact.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <a href={urbanxContact.phoneHref} className="inline-flex items-center gap-2 rounded-md border-2 border-white/40 px-7 py-3.5 font-semibold text-white transition-colors hover:bg-white hover:text-primary">
