    ...
    <SiteLayout>
      ...
      <section className="py-20 md:py-28">
        <div className="container-x grid gap-14 lg:grid-cols-2 lg:items-center">
          <div>
            <div className="mb-3 text-xs font-semibold uppercase tracking-[0.3em] text-gold">About Us</div>
            ...
            <p className="leading-relaxed text-foreground/80">
              The focus is simple: nutritious meals, disciplined operations and dependable service for educational institutions and other high-volume food service needs.
            </p>
          </div>

          <div className="grid gap-4 sm:grid-cols-2">
            {royalFoodsMetrics.map((metric) => (
              <div key={metric.label} className="rounded-2xl bg-card p-7 text-center shadow-card-luxe">
                <div className="text-4xl font-bold text-primary">{metric.value}</div>
                <div className="mt-2 text-xs uppercase tracking-[0.2em] text-muted-foreground">{metric.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-secondary/40 py-20">
        <div className="container-x">
          <div className="mx-auto mb-14 max-w-3xl text-center">
            <div className="mb-3 text-xs font-semibold uppercase tracking-[0.3em] text-gold">Why Choose Royal Foods</div>
            <h2 className="text-3xl font-bold text-primary md:text-5xl">Experience, hygiene and consistency</h2>
          </div>
      ...
      <section className="py-20 md:py-28">
        <div className="container-x grid gap-14 lg:grid-cols-2">
          <div>
            <div className="mb-3 text-xs font-semibold uppercase tracking-[0.3em] text-gold">Our Services</div>
            <h2 className="gold-underline mb-6 text-3xl font-bold text-primary md:text-5xl">Built for institutional food service</h2>
            <div className="mt-10 grid gap-4 sm:grid-cols-2">
              {royalFoodsServices.map((service) => (
                <div key={service} className="rounded-xl bg-secondary p-5">
          ...
          <div className="rounded-3xl bg-card p-8 shadow-luxe">
            <div className="mb-3 text-xs font-semibold uppercase tracking-[0.3em] text-gold">Food and Menu Focus</div>
            <h3 className="mb-5 text-3xl font-bold text-primary">Meals designed for health and satisfaction</h3>
            ...
            <div className="mt-8 rounded-2xl bg-primary p-5 text-white">
              ...
              <p className="mt-2 text-sm text-white/80">
                Our cloud kitchen and institutional food operations are supported by hygienic systems and more than 1000 square feet of kitchen space.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-secondary/40 py-20">
        <div className="container-x">
          <div className="mb-12">
            <div className="mb-3 text-xs font-semibold uppercase tracking-[0.3em] text-gold">Operational Strength</div>
            <h2 className="text-3xl font-bold text-primary md:text-5xl">How the service is structured</h2>
          </div>
      ...
      <section className="py-20 md:py-28">
        <div className="container-x grid gap-8 lg:grid-cols-2">
          <div className="rounded-3xl bg-card p-8 shadow-luxe">
            <div className="mb-3 text-xs font-semibold uppercase tracking-[0.3em] text-gold">Director's Message</div>
            <h3 className="mb-4 text-3xl font-bold text-primary">Quality food is the foundation of student well-being</h3>
            ...
            <div className="mt-6 rounded-2xl border border-gold/30 bg-gold/10 p-5 text-sm text-foreground/90">
              Continuous improvement, operational excellence and customer satisfaction remain at the center of our work.
            </div>
          </div>

          <div className="rounded-3xl bg-primary p-8 text-white shadow-luxe">
            <div className="mb-3 text-xs font-semibold uppercase tracking-[0.3em] text-gold">Quality Commitment</div>
            <h3 className="mb-5 text-3xl font-bold">Every meal is served with discipline and care</h3>
            <ul className="space-y-4">
      ...
      <section className="bg-secondary/40 py-20">
        <div className="container-x">
          <div className="mx-auto mb-12 max-w-3xl text-center">
            <div className="mb-3 text-xs font-semibold uppercase tracking-[0.3em] text-gold">Contact</div>
            <h2 className="text-3xl font-bold text-primary md:text-5xl">Talk to the Royal Foods team</h2>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="rounded-2xl bg-card p-7 shadow-card-luxe">
              ...
              <a href={royalFoodsContact.emailHref} className="text-muted-foreground hover:text-gold">
                {royalFoodsContact.email}
              </a>
              <p className="mt-4 text-sm text-muted-foreground">Director: {royalFoodsContact.director}</p>
            </div>
          </div>
