        ...
        <div className="container-x grid gap-14 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-8 mb-5 text-lg text-muted-foreground">
              Urbanx is an emerging destination in Pune that connects the services people need most
              under one platform. We help customers manage homes, food, interiors, projects and
              daily operations with more confidence and less friction.
            </p>
            <p className="mb-5 leading-relaxed text-foreground/80">
              The goal is simple: make life easier, faster and more convenient by combining real
              estate support, architectural and interior expertise, landscaping, event management,
              food services, housekeeping, gardening and IT solutions in one ecosystem.
            </p>
            <p className="leading-relaxed text-foreground/80">
              That means one trusted partner for discovery, planning, delivery and ongoing support
              across every stage of modern urban living.
            </p>
          </div>
          ...
          <div className="relative">
            <img
              ...
              className="h-[320px] w-full rounded-2xl object-cover shadow-luxe sm:h-[420px] lg:h-[520px]"
              loading="eager"
              decoding="async"
              fetchPriority="high"
            />
        ...
        <div className="container-x">
          <div className="mx-auto mb-14 max-w-3xl text-center">
            ...
            <h2 className="text-3xl font-bold text-primary md:text-5xl">
              A complete ecosystem for daily life
            </h2>
          </div>
      ...
      <section className="py-20 md:py-28">
        <div className="container-x grid gap-14 lg:grid-cols-2 lg:items-start">
          <div>
            ...
            <h2 className="gold-underline mb-8 text-3xl font-bold text-primary md:text-5xl">
          ...
          <div className="rounded-3xl bg-card p-8 shadow-luxe">
            ...
            <h3 className="mb-5 text-3xl font-bold text-primary">
              Work that reflects the Urbanx standard
            </h3>
            <div className="space-y-4">
            ...
            <div className="mt-8 rounded-2xl bg-primary p-6 text-white">
              ...
              <p className="leading-relaxed text-white/80">
                {urbanxContact.director} leads the company from {urbanxContact.office}, with a focus
                on reliability, service quality and long-term relationships.
              </p>
              <div className="mt-4 flex flex-wrap gap-3 text-sm">
                <a
                  href={urbanxContact.phoneHref}
                  className="inline-flex items-center gap-2 rounded-md border border-white/20 px-4 py-2 hover:bg-white/10"
                >
          ...
          <div className="rounded-3xl bg-gradient-to-br from-primary via-navy to-primary p-10 text-center text-white shadow-luxe md:p-16">
            <div className="mx-auto max-w-3xl">
              ...
              <h2 className="mb-4 text-3xl font-bold md:text-5xl">
                One platform. Multiple services. A better daily experience.
              </h2>
              <p className="mb-8 text-white/80">
                From housing and food to interiors, events, cleaning and support services, Urbanx is
                designed to keep everything connected.
              </p>
              <Link
                to="/services"
